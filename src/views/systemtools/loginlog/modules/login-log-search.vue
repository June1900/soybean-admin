      ...
      <NCollapseItem :title="$t('common.search')" name="login-log-search">
        <NForm ref="formRef" :model="model" label-placement="left" :label-width="80">
          <NGrid responsive="screen" item-responsive>
            <NFormItemGi span="24 s:12 m:6" :label="$t('page.systemTools.loginLog.search.username')" path="username" class="pr-24px">
              <NInput v-model:value="model.username" clearable />
            </NFormItemGi>
            <NFormItemGi span="24 s:12 m:6" :label="$t('page.systemTools.loginLog.search.status')" path="status" class="pr-24px">
              <NSelect
