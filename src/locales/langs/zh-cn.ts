...
import homeZhCN from '@/views/home/langs/zh-cn';
...
const local: App.I18n.Schema = {
  ...
  route: {
    ...
    'function_hide-child_one': '隐藏子菜单-1',
    'function_hide-child_two': '隐藏子菜单-2',
    'function_hide-child_three': '隐藏子菜单-3',
    'function_super-page': '多级路由',
    'system-tools': '系统工具',
